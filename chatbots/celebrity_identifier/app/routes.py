...
from app.utils.image_handler import ProcessImage
from app.utils.celeb_detector import CelebrityDetector
from app.utils.chatbot import QAEngine
...
def index():
    ...
    if request.method == "POST":
        if "image" in request.files:
            ...
            if image_file:
                img_bytes , face_box = process_image.process_image(image_file)
